...
- Name: feedback.spec.ts >> feedback form (Astro Actions) >> an invalid submission re-renders with server-side field errors
- Location: tests\e2e\feedback.spec.ts:29:3
...
Locator: locator('.banner.error, #message-error').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.banner.error, #message-error').first()
